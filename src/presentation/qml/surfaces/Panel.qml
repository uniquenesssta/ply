...
Rectangle {
    ...
    // The host/composition layer owns backdrop capture. R5-08 keeps the final
    // Figma blur radius as a surface contract without blurring this surface's
    // own pixels and misrepresenting that effect as a real backdrop blur.
    ...
    readonly property Item contentItemInternal: Item {
        id: contentHost
        parent: root
