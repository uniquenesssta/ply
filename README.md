...
| R7 — 媒体打开与播放列表 | In Progress | **R7-01 Local File Open implementation candidate 已提交**；Windows configure/build/QML lint/**81-test**/runtime validation pending |
